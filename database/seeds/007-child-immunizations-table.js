  ...
  return knex('child_immunizations').del()
    .then(function () {
      ...
      return knex('child_immunizations').insert([
        ...
        {childId: 1, dateReceived: '2018-06-22', location: 'The Clinic', immunizationId: 5},
        {childId: 1, dateReceived: '2018-08-22', location: 'The Clinic', immunizationId: 8},
        {childId: 1, dateReceived: '2018-08-22', location: 'The Clinic', immunizationId: 9},
